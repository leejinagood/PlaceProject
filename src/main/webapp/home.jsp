  ...
  <body>
    <div class="wrap">
      <div class="intro_bg">
        <div class="header">
          <div class="logo">
            <img src="image/swarm.png" height="40" width="40">
          </div>
          <div class="name">
            <h2>꿀팁</h2>
          </div>
        ...
        <div class="intro_text">
          <h1>일상 속의 꿀팁들을<br> 찾아보세요.</h1>
          <h4 class="contents1">몰랐던 생활 속 꿀팁 </h4>
        </div>
      </div>
      </div>
      <!-- intro end-->
      <!-- <ul class="amount">
        <li>
          <div>
            <div class="contents1">등록된 꿀팁 수</div>
            <div class="result">128,021</div>
          </div>
        </li>
        <li>
          <div>
            <div class="contents1">꿀팁 가입자 수</div>
